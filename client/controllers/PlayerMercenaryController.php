<?php
class PlayerMercenaryController extends Controller {
	...
	public function show() {
		...
		return $model->getJQGridGridData($qlimit, array(
				'SQL_SELECT' => 'a.id, a.p_id, b.p_name, a.me_id, c.me_name AS me_name_raw, a.me_name, a.me_status, a.me_count, a.me_place, a.me_fight_time',
				'SQL_FROM' => 'wog_mercenary_list a LEFT JOIN wog_player b ON b.p_id=a.p_id LEFT JOIN wog_mercenary_main c ON c.me_id=a.me_id'
		));
	}
}
