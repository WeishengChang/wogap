<?php
class ExchangeBookController extends Controller {
	...
	public function show() {
		...
		return $model->getJQGridGridData($qlimit, array(
				'SQL_SELECT' => 'a.eb_id, a.ex_id, b.ex_name, a.eb_body, a.eb_time',
				'SQL_FROM' => 'wog_exchange_book a LEFT JOIN wog_exchange_main b ON b.ex_id=a.ex_id',
